        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'> UberGo <span><i className="ri-user-3-line">4</i></span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-1 w-1/2'>
                    <h4 className='font-medium text-base'> Moto <span><i className="ri-user-3-line">1</i></span></h4>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'> Auto <span><i className="ri-user-3-line">3</i></span></h4>
                    <h5 className='font-medium text-sm'> 3 Mins away </h5>
